...
SEARCH_DIR("/home/xtrymind/local/toolchains/clang-rev/x86_64-pep/lib"); SEARCH_DIR("/home/xtrymind/local/toolchains/clang-rev/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
